...
batchConvertZhFile(inputPath = Path('3_i18n/zh_CN/LC_MESSAGES'), outputPath = Path('3_i18n/zh_TW/LC_MESSAGES'), extension = ['po'], method = 's2twp', replaceWords = [['Language: zh_CN', 'Language: zh_TW'], ['自由天堂', '自由港']])
